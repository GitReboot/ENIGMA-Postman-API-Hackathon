...
class MyWindow:
    ...
    def home(self):
        ...
        self.D_lbl0 = Label(newwin5, text='Personality Based Job Recommender Using Twitter Data ', fg='navy',
                            font=("Helvetica", 40))
        self.D_lbl0.place(x=110, y=30)
        self.lbl2 = Label(newwin5, text='Characteristics of Personalities:', bg='navy', fg='white',
                          font=("Helvetica", 25))
    ...
    def home1(self):
        ...
        canvas.pack(padx=0, pady=170)
        canvas.create_image(1250, 70, image=self.bg1, anchor="ne")
        self.D_lbl0 = Label(newwin15, text='Personality Based Job Recommender Using Twitter Data ', fg='navy',
                            font=("Helvetica", 40))
        self.D_lbl0.place(x=110, y=30)
